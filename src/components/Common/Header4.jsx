            ...
            <div className="main-bar bg-white">
              <div className="container" style={{ padding: "8px" }}>
                <div className="logo-header">
                  <div className="logo-header-inner logo-header-one" style={{ display: 'flex', alignItems: 'center' }}>
                    <img width='90' src={this.state.logo} alt="" />
                    <NavLink to={"./"} style={{ marginLeft: '10px' }}> {/* Adjust the margin as needed */}
                      <div style={{ color: "#fff" }}>ETMS</div>
                      <div style={{ color: "#fff", fontSize: "14px" }}>Group BD
                      </div>
                    </NavLink>
                  </div>
